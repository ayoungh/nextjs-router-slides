        ...
        <div className="grid md:grid-cols-3 gap-8 px-4 md:px-0 md:pt-0 h-[580px] md:h-auto overflow-auto pb-[100px] md:pb-0">
          <div className="space-y-8">
            <Card>
              ...
              <p className="text-[#878787] text-sm text-center">
                Page files need to be created for each route, which can lead to a
                disorganized codebase. As the number of pages grows, the
                complexity of the codebase increases, making it harder to manage.
              </p>
            </Card>
            <div className="px-8">
              <h2 className="text-6xl text-center leading-tight">
                Components for pages are away from the routes and harder to organise.
              </h2>
            </div>
          </div>
          <div>
          ...
          <div className="ml-auto w-full space-y-8">
            <Card className="min-h-[315px]">
              ...
              <p className="text-[#878787] text-sm text-center">
                Harder to test, harder to maintain, harder to scale. 
              </p>
            </Card>
            <Card className="min-h-[315px]">
              <svg
              ...
              <p className="text-[#878787] text-sm text-center">
                Limited to doing certain things in a certain way. 
              </p>
            </Card>
          </div>
        </div>
