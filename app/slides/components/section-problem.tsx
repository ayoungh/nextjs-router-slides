            ...
            <div className="space-y-8">
              <Card>
                ...
                <p className="text-[#878787] text-sm text-center">
                  Page files need to be created for each route, which can lead
                  to a disorganized codebase. As the number of pages grows, the
                  complexity of the codebase increases, making it harder to
                  manage.
                </p>
              ...
              <div className="px-8">
                <h2 className="text-6xl text-center leading-tight">
                  Components for pages are away from the routes and harder to
                  organise.
                </h2>
              </div>
            </div>
