        ...
        <div className="grid md:grid-cols-3 gap-8 px-4 md:px-0 md:pt-0 h-[580px] md:h-auto overflow-auto pb-[100px] md:pb-0">
          <div className="space-y-8">
            <Card>
              ...
              <p className="text-[#878787] text-sm text-center">
                All of our components are co-located with the routes that use
                them.
              </p>
          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <p className="text-[#878787] text-sm text-center">
                Nested layouts means things will be faster when they do not need
                to be changed. We also have more options to serverside render
